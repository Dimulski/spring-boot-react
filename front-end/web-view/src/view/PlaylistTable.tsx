...
export default class PlaylistTable extends React.Component<object, PlaylistTableState> {
        ...
        <Table aria-label="simple table">
          <TableHead>
            <TableRow sx={{ backgroundColor: "#64e0ea" }}>
              <TableCell sx={{ fontWeight: "bold", color: "#555555" }}>
                Artist
              </TableCell>
              <TableCell sx={{ fontWeight: "bold", color: "#555555" }}>
                Song
              ...
              >
                ...
                <TableCell align="left" sx={{ color: "#555555" }}>
                  <Fab
                    size="small"
                    aria-label="remove"
                    onClick={() => this.onRemoveSong(song.id)}
                  >
                    <DeleteIcon />
                  </Fab>
                </TableCell>
